//! Migrations 2 through 11: the incremental changes on top of the baseline.
//!
//! Each constant keeps the doc comment explaining why the change was made;
//! the SQL alone rarely says it.
